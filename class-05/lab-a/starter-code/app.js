...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    var doubleSum = sum(sum(a, b)[0], c)[0];
    var doubleMultiply = multiply(multiply(a, b)[0], c)[0];
    return[
        doubleSum,
        doubleMultiply,
        a + ' and ' + b + ' and ' + c + ' sum to ' + doubleSum + '.',
        'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + doubleMultiply + '.'
    ];
}
...
function sumArray(sumArr) { //eslint-disable-line
    var fourthSum = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
    return [
        fourthSum,
        testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + fourthSum + ' is their sum.'
    ];
}
